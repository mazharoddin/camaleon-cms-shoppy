module Themes::Shoppy::MainHelper
  ...
  def shoppy_on_install_theme(theme)
    ...
    group.add_field({"name"=>"footer bottom left", "slug"=>"footer_bottom_left"}, { field_key: "text_box",translate: true, default_value: "Copyright © MxM It Solutions. All rights reserved."})
    group.add_field({"name"=>"footer bottom right", "slug"=>"footer_bottom_right"}, { field_key: "text_box",translate: true, default_value: "Brought to you by <span><a target=\"_blank\" href=\"http://www.shoplid.com\">ShopLid</a></span>"})
